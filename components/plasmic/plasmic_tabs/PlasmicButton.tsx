...
import projectcss from "./plasmic_plasmic_tabs.module.css"; // plasmic-import: gLnoj82AzKVVT7qXiqAbHD/projectcss
import sty from "./PlasmicButton.module.css"; // plasmic-import: lBHNzts6tFyj/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: zq2s7N0xWucT/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 8K40faRNhuCj/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xf1Wy)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__uV9M)}
                role={"img"}
              />
            ),
